(function() {
  ...
  k.prototype = {
        ...
        if ("[object Array]" === {}.toString.call(a))
          for (var b = 0; b < a.length; b++) {
            ...
            switch (c[0]) {
              case "_setAccount":
                e._cz_account =
                  "[object String]" === {}.toString.call(c[1])
                    ? c[1]
                    : String(c[1]);
                break;
        ...
        if ("[object Array]" === {}.toString.call(a))
          switch (a[0]) {
            ...
            case "_deleteCustomVar":
              2 <= a.length &&
                ((d = a[1]), this.a.b[d] && (delete this.a.b[d], this.I()));
              break;
    ...
    ka: function() {
      try {
        ...
        for (b in this.a.b)
          "p" === this.a.b[b].h
            ? (this.a.b[b].h = 0)
            : "-1" !== this.a.b[b].h && a > this.a.b[b].h && delete this.a.b[b];
        this.I();
      } catch (c) {
        g(c, "cCV failed");
      }
    ...
    sa: function() {
      try {
        return (
          (this.a.A = e.navigator.systemLanguage || e.navigator.language),
    ...
    va: function() {
      try {
        return (
          e.screen.width && e.screen.height
            ? (this.a.J = e.screen.width + "x" + e.screen.height)
            : (this.a.J = "0x0"),
          this.a.J
        );
      } catch (a) {
    ...
    ta: function() {
      try {
        return (
          (this.a.B = this.i("rtime")),
          null === this.a.B && (this.a.B = 0),
          0 < this.U() &&
            432e5 < new Date().getTime() - this.U() &&
            (this.a.B++, (this.a.ea = new Date().getTime())),
          this.a.B
        );
      } catch (a) {
        g(a, "gRVT failed");
    ...
    xa: function() {
      try {
        return "none" === this.w()
          ? (this.a.Ia = 0)
          : (this.a.Ia = parseInt(
              (new Date().getTime() - 1e3 * this.w()) / 1e3
            ));
      } catch (a) {
        g(a, "gST failed");
      }
    ...
    ja: function() {
      try {
        return !1 === e.navigator.cookieEnabled
          ? (this.a.ma = !1)
          : (this.a.ma = !0);
      } catch (a) {
        g(a, "cCE failed");
    ...
    s: function() {
      try {
        ...
        this.a.f
          ? b.push("p=" + f(this.a.f))
          : "[object String]" === {}.toString.call(this.O) &&
            b.push("p=" + f(this.O));
        "[object String]" === {}.toString.call(this.v) &&
          b.push("ei=" + f(this.v));
        "[object String]" === {}.toString.call(this.b) &&
          b.push("cv=" + this.b);
        "[object String]" === {}.toString.call(this.D) &&
          b.push("pc=" + f(this.D));
        ...
        var c = b.join("&");
        "[object String]" === {}.toString.call(this.v)
          ? this.j(["http://ei.cnzz.com/stat.htm?" + c])
          : this.D || this.u
            ? this.j(["http://ca.cnzz.com/stat.htm?" + c])
            : (this.X && this.j(["http://" + this.X + "/stat.htm?" + c]),
              this.aa && this.j(["http://" + this.aa + "/stat.htm?" + c]));
      } catch (d) {
        g(d, "sD failed");
      }
    },
    ...
    j: function(a) {
      try {
        for (var b = a.length, c = null, d = 0; d < b; d++)
          a[d] &&
            ((c = "cnzz_image_" + Math.floor(2147483648 * Math.random())),
            (e[c] = new Image()),
            (e[c].la = c),
            ...
            (e[c].src =
              a[d] + "&rnd=" + Math.floor(2147483648 * Math.random())));
      } catch (l) {
        g(l, "cR failed");
      }
    },
